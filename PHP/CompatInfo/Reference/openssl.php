    ...
    extends PHP_CompatInfo_Reference_PluginsAbstract
{
    ...
    public function getConstants($extension = null, $version = null, $condition = null)
    {
        ...
        $items = array(
            ...
            'OPENSSL_ALGO_SHA224'            => array('5.4.8', ''),
            'OPENSSL_ALGO_SHA256'            => array('5.4.8', ''),
            'OPENSSL_ALGO_SHA384'            => array('5.4.8', ''),
            'OPENSSL_ALGO_SHA512'            => array('5.4.8', ''),
            'OPENSSL_ALGO_RMD160'            => array('5.4.8', ''),
