    ...
    public function getFunctions($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('4' == $version)) {
            $version4 = array(
                ...
                'import_request_variables'       => array('4.0.7', '5.3.10'),
                ...
                'define_syslog_variables'        => array('4.0.0', '5.3.10'),
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'getimagesizefromstring'         => array('5.4.0-dev', ''),
                'headers_list'                   => array('5.0.0', ''),
                'header_register_callback'       => array('5.4.0-dev', ''),
                'header_remove'                  => array('5.3.0', ''),
                'hex2bin'                        => array('5.4.0-dev', ''),
                'http_response_code'             => array('5.4.0-dev', ''),
                ...
                'stream_set_chunk_size'          => array('5.4.0-dev', ''),
    ...
    public function getConstants($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('4' == $version)) {
            $version4 = array(
                ...
                'STREAM_ENFORCE_SAFE_MODE'       => array('4.0.0', '5.3.10'),
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'ENT_DISALLOWED'                    => array('5.4.0-dev', ''),
                'ENT_HTML401'                       => array('5.4.0-dev', ''),
                'ENT_HTML5'                         => array('5.4.0-dev', ''),
                'ENT_IGNORE'                        => array('5.3.0', ''),
                'ENT_SUBSTITUTE'                    => array('5.4.0-dev', ''),
                'ENT_XHTML'                         => array('5.4.0-dev', ''),
                'ENT_XML1'                          => array('5.4.0-dev', ''),
                ...
                'PHP_QUERY_RFC1738'                 => array('5.4.0-dev', ''),
                'PHP_QUERY_RFC3986'                 => array('5.4.0-dev', ''),
                ...
                'SCANDIR_SORT_ASCENDING'            => array('5.4.0-dev', ''),
                'SCANDIR_SORT_DESCENDING'           => array('5.4.0-dev', ''),
                'SCANDIR_SORT_NONE'                 => array('5.4.0-dev', ''),
                'SORT_FLAG_CASE'                    => array('5.4.0-dev', ''),
                'SORT_NATURAL'                      => array('5.4.0-dev', ''),
                ...
                'STREAM_META_ACCESS'                => array('5.4.0-dev', ''),
                'STREAM_META_GROUP'                 => array('5.4.0-dev', ''),
                'STREAM_META_GROUP_NAME'            => array('5.4.0-dev', ''),
                'STREAM_META_OWNER'                 => array('5.4.0-dev', ''),
                'STREAM_META_OWNER_NAME'            => array('5.4.0-dev', ''),
                'STREAM_META_TOUCH'                 => array('5.4.0-dev', ''),
    ...
    public function getTokens()
    {
        $version5 = array(
            ...
            'classMemberAccessOnInstantiation'
                                             => array('5.4.0-dev', ''),
            'arrayDereferencing'             => array('5.4.0-dev', ''),
            'insteadof'                      => array('5.4.0-dev', ''),
        );
