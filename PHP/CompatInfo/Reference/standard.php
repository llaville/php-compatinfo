    ...
    extends PHP_CompatInfo_Reference_PluginsAbstract
{
    ...
    public function getFunctions($extension = null, $version = null, $condition = null)
    {
        ...
        $items = array(
            ...
            'dechex'                         => array('4.0.0', ''),
            'decoct'                         => array('4.0.0', ''),
            'define_syslog_variables'        => array('4.0.0', '5.3.16'),
            'deg2rad'                        => array('4.0.0', ''),
            'dir'                            => array('4.0.0', ''),
            'dirname'                        => array('4.0.0', ''),
        ...
        $items = array(
            ...
            'hypot'                          => array('4.0.7', ''),
            'import_request_variables'       => array('4.0.7', '5.3.16'),
            'log1p'                          => array('4.0.7', ''),
            'sinh'                           => array('4.0.7', ''),
    ...
    public function getConstants($extension = null, $version = null, $condition = null)
    {
        ...
        $items = array(
            ...
            'STREAM_CRYPTO_METHOD_TLS_SERVER'
                                             => array('4.0.0', ''),
            'STREAM_ENFORCE_SAFE_MODE'       => array('4.0.0', '5.3.16'),
