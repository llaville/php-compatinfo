    ...
    extends PHP_CompatInfo_Reference_PluginsAbstract
{
    ...
    public function getConstants($extension = null, $version = null, $condition = null)
    {
        ...
        $items = array(
            ...
            'IPV6_HOPLIMIT'                  => array('5.5.0', ''),
            'IPV6_MULTICAST_HOPS'            => array('5.4.0', ''),
            'IPV6_MULTICAST_IF'              => array('5.4.0', ''),
            'IPV6_MULTICAST_LOOP'            => array('5.4.0', ''),
            'IPV6_PKTINFO'                   => array('5.5.0', ''),
            'IPV6_RECVTCLASS'                => array('5.5.0', ''),
            'IPV6_RECVHOPLIMIT'              => array('5.5.0', ''),
            'IPV6_RECVPKTINFO'               => array('5.5.0', ''),
            'IPV6_TCLASS'                    => array('5.5.0', ''),
            'IPV6_UNICAST_HOPS'              => array('5.5.0', ''),
            ...
            'MSG_CMSG_CLOEXEC'               => array('5.5.0', ''),
            'MSG_CTRUNC'                     => array('5.5.0', ''),
            'MSG_CONFIRM'                    => array('5.5.0', ''),
            'MSG_DONTROUTE'                  => array('4.1.0', ''),
            'MSG_DONTWAIT'                   => array('5.2.10', ''),
            'MSG_EOF'                        => array('5.2.4', ''),
            'MSG_ERRQUEUE'                   => array('5.5.0', ''),
            'MSG_EOR'                        => array('5.2.4', ''),
            'MSG_MORE'                       => array('5.5.0', ''),
            'MSG_NOSIGNAL'                   => array('5.5.0', ''),
            'MSG_OOB'                        => array('4.1.0', ''),
            'MSG_PEEK'                       => array('4.1.0', ''),
            'MSG_TRUNC'                      => array('5.5.0', ''),
            'MSG_WAITFORONE'                 => array('5.5.0', ''),
            'MSG_WAITALL'                    => array('4.1.0', ''),
            'PHP_BINARY_READ'                => array('4.1.0', ''),
            'PHP_NORMAL_READ'                => array('4.1.0', ''),
            'SCM_CREDENTIALS'                => array('5.5.0', ''),
            'SCM_RIGHTS'                     => array('5.5.0', ''),
