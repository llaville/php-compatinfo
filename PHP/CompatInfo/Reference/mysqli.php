        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'mysqli_disable_reads_from_master'
                                                 => array('5.0.0', '5.3.0'),
                'mysqli_disable_rpl_parse'       => array('5.0.0', '5.3.0'),
                'mysqli_dump_debug_info'         => array('5.0.0', ''),
                'mysqli_embedded_server_end'     => array('5.0.0', ''),
                'mysqli_embedded_server_start'   => array('5.0.0', ''),
                'mysqli_enable_reads_from_master'=> array('5.0.0', '5.3.0'),
                'mysqli_enable_rpl_parse'        => array('5.0.0', '5.3.0'),
                ...
                'mysqli_master_query'            => array('5.0.0', '5.3.0'),
                ...
                'mysqli_rpl_parse_enabled'       => array('5.0.0', '5.3.0'),
                'mysqli_rpl_probe'               => array('5.0.0', '5.3.0'),
                'mysqli_rpl_query_type'          => array('5.0.0', '5.3.0'),
                'mysqli_select_db'               => array('5.0.0', ''),
                'mysqli_send_long_data'          => array('5.0.0', ''),
                'mysqli_send_query'              => array('5.0.0', '5.3.0'),
                ...
                'mysqli_slave_query'             => array('5.0.0', '5.3.0'),
    ...
    public function getConstants($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'MYSQLI_RPL_MASTER'              => array('5.0.0', '5.3.0'),
                'MYSQLI_RPL_SLAVE'               => array('5.0.0', '5.3.0'),
                'MYSQLI_RPL_ADMIN'               => array('5.0.0', '5.3.0'),
            );
            $constants = array_merge(
                $constants,
                $version5
