    ...
    public function getFunctions($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'mysqli_bind_param'              => array('5.0.0', ''),
                'mysqli_bind_result'             => array('5.0.0', ''),
                'mysqli_change_user'             => array('5.0.0', ''),
                'mysqli_character_set_name'      => array('5.0.0', ''),
                'mysqli_client_encoding'         => array('5.0.0', ''),
                ...
                'mysqli_get_metadata'            => array('5.0.0', ''),
                ...
                'mysqli_param_count'             => array('5.0.0', ''),
    ...
    public function getConstants($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'MYSQLI_OPT_NET_CMD_BUFFER_SIZE' => array('5.0.0', ''),
                ...
                'MYSQLI_BINARY_FLAG'             => array('5.0.0', ''),
                'MYSQLI_NO_DEFAULT_VALUE_FLAG'   => array('5.0.0', ''),
                'MYSQLI_ON_UPDATE_NOW_FLAG'      => array('5.0.0', ''),
                ...
                'MYSQLI_DEBUG_TRACE_ENABLED'     => array('5.0.0', ''),
                'MYSQLI_SERVER_QUERY_NO_GOOD_INDEX_USED'
                                                 => array('5.0.0', ''),
                'MYSQLI_SERVER_QUERY_NO_INDEX_USED'
                                                 => array('5.0.0', ''),
                'MYSQLI_SERVER_QUERY_WAS_SLOW'   => array('5.0.0', ''),
                'MYSQLI_REFRESH_GRANT'           => array('5.0.0', ''),
                'MYSQLI_REFRESH_LOG'             => array('5.0.0', ''),
                'MYSQLI_REFRESH_TABLES'          => array('5.0.0', ''),
                'MYSQLI_REFRESH_HOSTS'           => array('5.0.0', ''),
                'MYSQLI_REFRESH_STATUS'          => array('5.0.0', ''),
                'MYSQLI_REFRESH_THREADS'         => array('5.0.0', ''),
                'MYSQLI_REFRESH_SLAVE'           => array('5.0.0', ''),
                'MYSQLI_REFRESH_MASTER'          => array('5.0.0', ''),
                'MYSQLI_REFRESH_BACKUP_LOG'      => array('5.0.0', ''),
