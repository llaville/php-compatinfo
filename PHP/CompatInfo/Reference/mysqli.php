    ...
    public function getFunctions($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'mysqli_bind_param'              => array('5.0.0', '5.3.9'),
                'mysqli_bind_result'             => array('5.0.0', '5.3.9'),
                'mysqli_change_user'             => array('5.0.0', ''),
                'mysqli_character_set_name'      => array('5.0.0', ''),
                'mysqli_client_encoding'         => array('5.0.0', '5.3.9'),
                ...
                'mysqli_fetch'                   => array('5.0.0', '5.3.9'),
                ...
                'mysqli_get_metadata'            => array('5.0.0', '5.3.9'),
                ...
                'mysqli_param_count'             => array('5.0.0', '5.3.9'),
                ...
                'mysqli_send_long_data'          => array('5.0.0', '5.3.9'),
