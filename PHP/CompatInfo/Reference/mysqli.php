    ...
    public function getFunctions($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'mysqli_bind_param'              => array('5.0.0', '5.3.10'),
                'mysqli_bind_result'             => array('5.0.0', '5.3.10'),
                'mysqli_change_user'             => array('5.0.0', ''),
                'mysqli_character_set_name'      => array('5.0.0', ''),
                'mysqli_client_encoding'         => array('5.0.0', '5.3.10'),
                ...
                'mysqli_error_list'              => array('5.4.0-dev', ''),
                'mysqli_escape_string'           => array('5.0.0', ''),
                'mysqli_execute'                 => array('5.0.0', ''),
                'mysqli_fetch'                   => array('5.0.0', '5.3.10'),
                ...
                'mysqli_get_metadata'            => array('5.0.0', '5.3.10'),
                ...
                'mysqli_param_count'             => array('5.0.0', '5.3.10'),
                ...
                'mysqli_send_long_data'          => array('5.0.0', '5.3.10'),
                ...
                'mysqli_stmt_error_list'         => array('5.4.0-dev', ''),
