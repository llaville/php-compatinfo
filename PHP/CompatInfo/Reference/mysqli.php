 ...
 */
class PHP_CompatInfo_Reference_Mysqli
    extends PHP_CompatInfo_Reference_PluginsAbstract
{
    ...
    public function getFunctions($extension = null, $version = null, $condition = null)
    {
        ...
        $items = array(
            ...
            'mysqli_begin_transaction'       => array('5.5.0', ''),
            ...
            'mysqli_disable_reads_from_master'
                                             => array('5.0.0', self::LATEST_PHP_5_2),
            ...
            'mysqli_release_savepoint'       => array('5.5.0', ''),
    ...
    public function getConstants($extension = null, $version = null, $condition = null)
    {
        ...
        $items = array(
            ...
            'MYSQLI_SERVER_PUBLIC_KEY'       => array('5.5.0', ''),
            ...
            'MYSQLI_TRANS_COR_AND_CHAIN'     => array('5.5.0', ''),
            'MYSQLI_TRANS_COR_AND_NO_CHAIN'  => array('5.5.0', ''),
            'MYSQLI_TRANS_COR_NO_RELEASE'    => array('5.5.0', ''),
            'MYSQLI_TRANS_COR_RELEASE'       => array('5.5.0', ''),
            'MYSQLI_TRANS_START_READ_ONLY'   => array('5.5.0', ''),
            'MYSQLI_TRANS_START_READ_WRITE'  => array('5.5.0', ''),
