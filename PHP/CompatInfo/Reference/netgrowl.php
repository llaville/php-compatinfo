...
class PHP_CompatInfo_Reference_Net_Growl implements PHP_CompatInfo_Reference
{
    ...
    /**
     * Gets informations about package
     *
     * @param string $extension OPTIONAL
     * @param string $version   OPTIONAL PHP version
     *                          (4 => only PHP4, 5 or null => PHP4 + PHP5)
    ...
    public function getClasses($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('4' == $version)) {
            $version4 = array(
                'Net_Growl_Application'          => array('4.0.0', ''),
                'Net_Growl_GntpMock'             => array('4.0.0', ''),
                'Net_Growl_Response'             => array('4.0.0', ''),
                'Net_Growl_Udp'                  => array('4.0.6', ''),
            );
            $classes = array_merge(
                $classes,
                $version4
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                'Net_Growl'                      => array('5.1.2', ''),
                'Net_Growl_Exception'            => array('5.0.0', ''),
                'Net_Growl_Gntp'                 => array('5.1.2', ''),
            );
            $classes = array_merge(
                $classes,
                $version5
