<?php
/**
 * Version informations about sysvsem extension
 *
 * PHP version 5
 *
 * @category PHP
...
/**
 * All interfaces, classes, functions, constants about sysvsem extension
 *
 * @category PHP
 * @package  PHP_CompatInfo
 * @author   Remi Collet <Remi@FamilleCollet.com>
 ...
 */
class PHP_CompatInfo_Reference_Sysvsem implements PHP_CompatInfo_Reference
{
    /**
    ...
    public function getFunctions($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('4' == $version)) {
            $version4 = array(
                'sem_acquire'                       => array('4.0.0', ''),
                'sem_get'                           => array('4.0.0', ''),
                'sem_release'                       => array('4.0.0', ''),
                'sem_remove'                        => array('4.1.0', ''),
            );
