    ...
    public function getConstants($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'U_IDNA_ACE_PREFIX_ERROR'           => array('5.4.0', ''),
                'U_IDNA_CHECK_BIDI_ERROR'           => array('5.4.0', ''),
                'U_IDNA_DOMAIN_NAME_TOO_LONG_ERROR' => array('5.4.0', ''),
                'U_IDNA_ERROR_LIMIT'                => array('5.4.0', ''),
                'U_IDNA_ERROR_START'                => array('5.4.0', ''),
                'U_IDNA_LABEL_TOO_LONG_ERROR'       => array('5.4.0', ''),
                'U_IDNA_PROHIBITED_ERROR'           => array('5.4.0', ''),
                'U_IDNA_STD3_ASCII_RULES_ERROR'     => array('5.4.0', ''),
                'U_IDNA_UNASSIGNED_ERROR'           => array('5.4.0', ''),
                'U_IDNA_VERIFICATION_ERROR'         => array('5.4.0', ''),
                'U_IDNA_ZERO_LENGTH_LABEL_ERROR'    => array('5.4.0', ''),
