    ...
    public function getFunctions($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'transliterator_create'             => array('5.4.0-dev', ''),
                'transliterator_create_from_rules'  => array('5.4.0-dev', ''),
                'transliterator_create_inverse'     => array('5.4.0-dev', ''),
                'transliterator_get_error_code'     => array('5.4.0-dev', ''),
                'transliterator_get_error_message'  => array('5.4.0-dev', ''),
                'transliterator_list_ids'           => array('5.4.0-dev', ''),
                'transliterator_transliterate'      => array('5.4.0-dev', ''),
    ...
    public function getConstants($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'IDNA_CHECK_BIDI'                   => array('5.4.0-dev', ''),
                'IDNA_CHECK_CONTEXTJ'               => array('5.4.0-dev', ''),
                'IDNA_DEFAULT'                      => array('5.2.4', ''),
                'IDNA_ERROR_BIDI'                   => array('5.4.0-dev', ''),
                'IDNA_ERROR_CONTEXTJ'               => array('5.4.0-dev', ''),
                'IDNA_ERROR_DISALLOWED'             => array('5.4.0-dev', ''),
                'IDNA_ERROR_DOMAIN_NAME_TOO_LONG'   => array('5.4.0-dev', ''),
                'IDNA_ERROR_EMPTY_LABEL'            => array('5.4.0-dev', ''),
                'IDNA_ERROR_HYPHEN_3_4'             => array('5.4.0-dev', ''),
                'IDNA_ERROR_INVALID_ACE_LABEL'      => array('5.4.0-dev', ''),
                'IDNA_ERROR_LABEL_HAS_DOT'          => array('5.4.0-dev', ''),
                'IDNA_ERROR_LABEL_TOO_LONG'         => array('5.4.0-dev', ''),
                'IDNA_ERROR_LEADING_COMBINING_MARK' => array('5.4.0-dev', ''),
                'IDNA_ERROR_LEADING_HYPHEN'         => array('5.4.0-dev', ''),
                'IDNA_ERROR_PUNYCODE'               => array('5.4.0-dev', ''),
                'IDNA_ERROR_TRAILING_HYPHEN'        => array('5.4.0-dev', ''),
                'IDNA_USE_STD3_RULES'               => array('5.2.4', ''),
                'IDNA_NONTRANSITIONAL_TO_ASCII'     => array('5.4.0-dev', ''),
                'IDNA_NONTRANSITIONAL_TO_UNICODE'   => array('5.4.0-dev', ''),
                'INTL_MAX_LOCALE_LEN'               => array('5.2.4', ''),
                'INTL_ICU_VERSION'                  => array('5.3.7', ''),
                'INTL_ICU_DATA_VERSION'             => array('5.3.7', ''),
                'INTL_IDNA_VARIANT_2003'            => array('5.4.0-dev', ''),
                'INTL_IDNA_VARIANT_UTS46'           => array('5.4.0-dev', ''),
                ...
                'U_IDNA_ACE_PREFIX_ERROR'           => array('5.4.0-dev', ''),
                'U_IDNA_CHECK_BIDI_ERROR'           => array('5.4.0-dev', ''),
                'U_IDNA_DOMAIN_NAME_TOO_LONG_ERROR' => array('5.4.0-dev', ''),
                'U_IDNA_ERROR_LIMIT'                => array('5.4.0-dev', ''),
                'U_IDNA_ERROR_START'                => array('5.4.0-dev', ''),
                'U_IDNA_LABEL_TOO_LONG_ERROR'       => array('5.4.0-dev', ''),
                'U_IDNA_PROHIBITED_ERROR'           => array('5.4.0-dev', ''),
                'U_IDNA_STD3_ASCII_RULES_ERROR'     => array('5.4.0-dev', ''),
                'U_IDNA_UNASSIGNED_ERROR'           => array('5.4.0-dev', ''),
                'U_IDNA_VERIFICATION_ERROR'         => array('5.4.0-dev', ''),
                'U_IDNA_ZERO_LENGTH_LABEL_ERROR'    => array('5.4.0-dev', ''),
