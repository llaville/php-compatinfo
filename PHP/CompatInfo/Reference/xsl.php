 ...
 */
class PHP_CompatInfo_Reference_Xsl implements PHP_CompatInfo_Reference
{
    /**
    ...
    public function getConstants($extension = null, $version = null)
    {
        ...
        if ((null == $version ) || ('5' == $version)) {
            $version5 = array(
                ...
                'XSL_SECPREF_CREATE_DIRECTORY'   => array('5.4.0-dev', ''),
                'XSL_SECPREF_DEFAULT'            => array('5.4.0-dev', ''),
                'XSL_SECPREF_NONE'               => array('5.4.0-dev', ''),
                'XSL_SECPREF_READ_FILE'          => array('5.4.0-dev', ''),
                'XSL_SECPREF_READ_NETWORK'       => array('5.4.0-dev', ''),
                'XSL_SECPREF_WRITE_FILE'         => array('5.4.0-dev', ''),
                'XSL_SECPREF_WRITE_NETWORK'      => array('5.4.0-dev', ''),
