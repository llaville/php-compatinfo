    ...
    extends PHP_CompatInfo_Reference_PluginsAbstract
{
    ...
    public function getConstants($extension = null, $version = null, $condition = null)
    {
        ...
        $release = false;
        $items = array(
            'CURL_FNMATCHFUNC_FAIL'          => array('5.5.0-dev', ''),
            'CURL_FNMATCHFUNC_MATCH'         => array('5.5.0-dev', ''),
            'CURL_FNMATCHFUNC_NOMATCH'       => array('5.5.0-dev', ''),
            ...
            'CURL_LOCK_DATA_COOKIE'          => array('5.5.0-dev', ''),
            'CURL_LOCK_DATA_DNS'             => array('5.5.0-dev', ''),
            'CURL_LOCK_DATA_SSL_SESSION'     => array('5.5.0-dev', ''),
            ...
            'CURL_RTSPREQ_OPTIONS'           => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_PAUSE'             => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_PLAY'              => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_RECEIVE'           => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_RECORD'            => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_SETUP'             => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_SET_PARAMETER'     => array('5.5.0-dev', ''),
            'CURL_RTSPREQ_TEARDOWN'          => array('5.5.0-dev', ''),
            'CURL_SSLVERSION_DEFAULT'        => array('5.5.0-dev', ''),
            'CURL_SSLVERSION_SSLv2'          => array('5.5.0-dev', ''),
            'CURL_SSLVERSION_SSLv3'          => array('5.5.0-dev', ''),
            'CURL_SSLVERSION_TLSv1'          => array('5.5.0-dev', ''),
            'CURL_TIMECOND_IFMODSINCE'       => array('4.0.2', ''),
            'CURL_TIMECOND_IFUNMODSINCE'     => array('4.0.2', ''),
            'CURL_TIMECOND_LASTMOD'          => array('4.0.2', ''),
            'CURL_TIMECOND_NONE'             => array('5.5.0-dev', ''),
            'CURL_TLSAUTH_SRP'               => array('5.5.0-dev', ''),
            ...
            'CURLAUTH_DIGEST_IE'             => array('5.5.0-dev', ''),
            'CURLAUTH_GSSNEGOTIATE'          => array('4.0.2', ''),
            'CURLAUTH_NONE'                  => array('5.5.0-dev', ''),
            'CURLAUTH_NTLM'                  => array('4.0.2', ''),
            'CURLAUTH_ONLY'                  => array('5.5.0-dev', ''),
            ...
            'CURLE_BAD_DOWNLOAD_RESUME'      => array('5.5.0-dev', ''),
            ...
            'CURLE_HTTP_RETURNED_ERROR'      => array('5.5.0-dev', ''),
            ...
            'CURLE_OPERATION_TIMEDOUT'       => array('5.5.0-dev', ''),
            ...
            'CURLFTPSSL_CCC_ACTIVE'          => array('5.5.0-dev', ''),
            'CURLFTPSSL_CCC_NONE'            => array('5.5.0-dev', ''),
            'CURLFTPSSL_CCC_PASSIVE'         => array('5.5.0-dev', ''),
            ...
            'CURLINFO_COOKIELIST'            => array('5.5.0-dev', ''),
            'CURLINFO_EFFECTIVE_URL'         => array('4.0.2', ''),
            'CURLINFO_FILETIME'              => array('4.0.2', ''),
            'CURLINFO_FTP_ENTRY_PATH'        => array('5.5.0-dev', ''),
            'CURLINFO_HEADER_OUT'            => array('5.1.3', ''),
            'CURLINFO_HEADER_SIZE'           => array('4.0.2', ''),
            'CURLINFO_HTTPAUTH_AVAIL'        => array('5.5.0-dev', ''),
            'CURLINFO_HTTP_CODE'             => array('4.0.2', ''),
            'CURLINFO_HTTP_CONNECTCODE'      => array('5.5.0-dev', ''),
            'CURLINFO_LASTONE'               => array('5.5.0-dev', ''),
            'CURLINFO_LOCAL_IP'              => array('5.4.7', ''),
            'CURLINFO_LOCAL_PORT'            => array('5.4.7', ''),
            'CURLINFO_NAMELOOKUP_TIME'       => array('4.0.2', ''),
            'CURLINFO_NUM_CONNECTS'          => array('5.5.0-dev', ''),
            'CURLINFO_OS_ERRNO'              => array('5.5.0-dev', ''),
            ...
            'CURLINFO_PROXYAUTH_AVAIL'       => array('5.5.0-dev', ''),
            ...
            'CURLINFO_RESPONSE_CODE'         => array('5.5.0-dev', ''),
            'CURLINFO_RTSP_CLIENT_CSEQ'      => array('5.5.0-dev', ''),
            'CURLINFO_RTSP_CSEQ_RECV'        => array('5.5.0-dev', ''),
            'CURLINFO_RTSP_SERVER_CSEQ'      => array('5.5.0-dev', ''),
            'CURLINFO_RTSP_SESSION_ID'       => array('5.5.0-dev', ''),
            ...
            'CURLINFO_SSL_ENGINES'           => array('5.5.0-dev', ''),
            ...
            'CURLOPT_CONNECT_ONLY'           => array('5.5.0-dev', ''),
            ...
            'CURLOPT_FNMATCH_FUNCTION'       => array('5.5.0-dev', ''),
            ...
            'CURLOPT_FTP_ACCOUNT'            => array('5.5.0-dev', ''),
            'CURLOPT_FTP_ALTERNATIVE_TO_USER'=> array('5.5.0-dev', ''),
            'CURLOPT_FTP_CREATE_MISSING_DIRS'
                                             => array('4.0.2', ''),
            'CURLOPT_FTP_FILEMETHOD'         => array('5.3.0', ''),
            'CURLOPT_FTP_RESPONSE_TIMEOUT'   => array('5.5.0-dev', ''),
            'CURLOPT_FTP_SKIP_PASV_IP'       => array('5.3.2', ''),
            'CURLOPT_FTP_SSL'                => array('5.2.0', ''),
            'CURLOPT_FTP_SSL_CCC'            => array('5.5.0-dev', ''),
            ...
            'CURLOPT_HTTP_CONTENT_DECODING'  => array('5.5.0-dev', ''),
            'CURLOPT_HTTP_TRANSFER_DECODING' => array('5.5.0-dev', ''),
            'CURLOPT_HTTP_VERSION'           => array('4.0.2', ''),
            'CURLOPT_IGNORE_CONTENT_LENGTH'  => array('5.5.0-dev', ''),
            'CURLOPT_INFILE'                 => array('4.0.2', ''),
            'CURLOPT_INFILESIZE'             => array('4.0.2', ''),
            'CURLOPT_INTERFACE'              => array('4.0.2', ''),
            'CURLOPT_IPRESOLVE'              => array('5.3.0', ''),
            'CURLOPT_ISSUERCERT'             => array('5.5.0-dev', ''),
            'CURLOPT_KEYPASSWD'              => array('5.3.0', ''),
            'CURLOPT_KRBLEVEL'               => array('5.5.0-dev', ''),
            'CURLOPT_KRB4LEVEL'              => array('4.0.2', ''),
            'CURLOPT_LOCALPORT'              => array('5.5.0-dev', ''),
            ...
            'CURLOPT_MAXFILESIZE'            => array('5.5.0-dev', ''),
            ...
            'CURLOPT_NETRC_FILE'             => array('5.5.0-dev', ''),
            'CURLOPT_NEW_DIRECTORY_PERMS'    => array('5.5.0-dev', ''),
            'CURLOPT_NEW_FILE_PERMS'         => array('5.5.0-dev', ''),
            'CURLOPT_NOBODY'                 => array('4.0.2', ''),
            'CURLOPT_NOPROGRESS'             => array('4.0.2', ''),
            'CURLOPT_NOPROXY'                => array('5.5.0-dev', ''),
            'CURLOPT_NOSIGNAL'               => array('4.0.2', ''),
            'CURLOPT_PASSWORD'               => array('5.5.0-dev', ''),
            ...
            'CURLOPT_PREQUOTE'               => array('5.5.0-dev', ''),
            ...
            'CURLOPT_PROXYPASSWORD'          => array('5.5.0-dev', ''),
            'CURLOPT_PROXYUSERNAME'          => array('5.5.0-dev', ''),
            'CURLOPT_PROXYPORT'              => array('4.0.2', ''),
            'CURLOPT_PROXYTYPE'              => array('4.0.2', ''),
            'CURLOPT_PROXYUSERPWD'           => array('4.0.2', ''),
            'CURLOPT_PROXY_TRANSFER_MODE'    => array('5.5.0-dev', ''),
            ...
            'CURLOPT_RESOLVE'                => array('5.5.0-dev', ''),
            'CURLOPT_RETURNTRANSFER'         => array('4.0.2', ''),
            'CURLOPT_RTSP_CLIENT_CSEQ'       => array('5.5.0-dev', ''),
            'CURLOPT_RTSP_REQUEST'           => array('5.5.0-dev', ''),
            'CURLOPT_RTSP_SERVER_CSEQ'       => array('5.5.0-dev', ''),
            ...
            'CURLOPT_SSH_HOST_PUBLIC_KEY_MD5'
                                             => array('5.3.0', ''),
            'CURLOPT_SSH_KNOWNHOSTS'         => array('5.5.0-dev', ''),
            ...
            'CURLOPT_SSL_SESSIONID_CACHE'    => array('5.5.0-dev', ''),
            ...
            'CURLOPT_TLSAUTH_PASSWORD'       => array('5.5.0-dev', ''),
            'CURLOPT_TLSAUTH_TYPE'           => array('5.5.0-dev', ''),
            'CURLOPT_TLSAUTH_USERNAME'       => array('5.5.0-dev', ''),
            'CURLOPT_TRANSFERTEXT'           => array('4.0.2', ''),
            'CURLOPT_TRANSFER_ENCODING'      => array('5.5.0-dev', ''),
            'CURLOPT_UNRESTRICTED_AUTH'      => array('4.0.2', ''),
            'CURLOPT_UPLOAD'                 => array('4.0.2', ''),
            'CURLOPT_URL'                    => array('4.0.2', ''),
            'CURLOPT_USERAGENT'              => array('4.0.2', ''),
            'CURLOPT_USERNAME'               => array('5.5.0-dev', ''),
            'CURLOPT_USERPWD'                => array('4.0.2', ''),
            'CURLOPT_USE_SSL'                => array('5.5.0-dev', ''),
            ...
            'CURLPROTO_GOPHER'               => array('5.5.0-dev', ''),
            'CURLPROTO_HTTP'                 => array('4.0.2', ''),
            'CURLPROTO_HTTPS'                => array('4.0.2', ''),
            'CURLPROTO_IMAP'                 => array('5.5.0-dev', ''),
            'CURLPROTO_IMAPS'                => array('5.5.0-dev', ''),
            'CURLPROTO_LDAP'                 => array('4.0.2', ''),
            'CURLPROTO_LDAPS'                => array('4.0.2', ''),
            'CURLPROTO_POP3'                 => array('5.5.0-dev', ''),
            'CURLPROTO_POP3S'                => array('5.5.0-dev', ''),
            'CURLPROTO_RTMP'                 => array('5.5.0-dev', ''),
            'CURLPROTO_RTMPE'                => array('5.5.0-dev', ''),
            'CURLPROTO_RTMPS'                => array('5.5.0-dev', ''),
            'CURLPROTO_RTMPT'                => array('5.5.0-dev', ''),
            'CURLPROTO_RTMPTE'               => array('5.5.0-dev', ''),
            'CURLPROTO_RTMPTS'               => array('5.5.0-dev', ''),
            'CURLPROTO_RTSP'                 => array('5.5.0-dev', ''),
            'CURLPROTO_SCP'                  => array('4.0.2', ''),
            'CURLPROTO_SFTP'                 => array('4.0.2', ''),
            'CURLPROTO_SMTP'                 => array('5.5.0-dev', ''),
            'CURLPROTO_SMTPS'                => array('5.5.0-dev', ''),
            ...
            'CURLSHOPT_NONE'                 => array('5.5.0-dev', ''),
            'CURLSHOPT_SHARE'                => array('5.5.0-dev', ''),
            'CURLSHOPT_UNSHARE'              => array('5.5.0-dev', ''),

            'CURLSSH_AUTH_ANY'               => array('5.5.0-dev', ''),
            ...
            'CURLUSESSL_TRY'                 => array('5.5.0-dev', ''),
