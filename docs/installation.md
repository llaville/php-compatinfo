...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/php-compatinfo" version="^7.3" copy="false" />
</phive>
```
...
```shell
composer require bartlett/php-compatinfo ^7.3
```
...
```shell
git clone -b 7.3 https://github.com/llaville/php-compatinfo.git
```
