...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.5.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.5.phar
$ mv phpcompatinfo-5.0.5.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.5.phar
$ php phpcompatinfo-5.0.5.phar --version
----
...
====
----
phpCompatInfo version 5.0.5 DB version 1.19.0 built Mar 16 2017 21:17:30 CET
----
====
