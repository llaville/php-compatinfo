...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.3.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.3.phar
$ mv phpcompatinfo-5.0.3.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.3.phar
$ php phpcompatinfo-5.0.3.phar --version
----
...
====
----
phpCompatInfo version 5.0.3 DB version 1.16.0 built Dec 15 2016 22:20:52 CET
----
====
