...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.8.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.8.phar
$ mv phpcompatinfo-5.0.8.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.8.phar
$ php phpcompatinfo-5.0.8.phar --version
----
...
====
----
phpCompatInfo version 5.0.8 DB version 1.23.0 built Jul 17 2017 13:38:37 CEST
----
====
