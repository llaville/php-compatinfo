...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.11.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.11.phar
$ mv phpcompatinfo-5.0.11.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.11.phar
$ php phpcompatinfo-5.0.11.phar --version
----
