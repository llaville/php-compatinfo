...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.2.0.phar
...
$ php phpcompatinfo-4.2.0.phar --version
----
...
====
----
phpCompatInfo version 4.2.0 DB built May 19 2015 08:22:43 CEST
----
====
