...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.0.0-RC2.phar
...
$ php phpcompatinfo-4.0.0-RC2.phar --version
----
...
====
----
phpCompatInfo version 4.0.0-RC2 DB built Mar 25 2015 07:58:29 CET
----
====
