...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.5.1.phar
...
$ php phpcompatinfo-4.5.1.phar --version
----
...
====
----
phpCompatInfo version 4.5.1 DB built Oct 09 2015 19:45:36 CEST
----
====
