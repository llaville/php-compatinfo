...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-3.6.1.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-3.6.1.phar
$ mv phpcompatinfo-3.6.1.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-3.6.1.phar
$ php phpcompatinfo-3.6.1.phar --version
----
