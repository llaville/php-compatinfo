...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.7.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.7.phar
$ mv phpcompatinfo-5.0.7.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.7.phar
$ php phpcompatinfo-5.0.7.phar --version
----
...
====
----
phpCompatInfo version 5.0.7 DB version 1.22.0 built Jun 10 2017 09:51:39 CEST
----
====
