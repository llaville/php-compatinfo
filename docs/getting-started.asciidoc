...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.4.1.phar
...
$ php phpcompatinfo-4.4.1.phar --version
----
...
====
----
phpCompatInfo version 4.4.1 DB built Jul 18 2015 07:08:35 CEST
----
====
