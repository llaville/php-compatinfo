...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.3.0.phar
...
$ php phpcompatinfo-4.3.0.phar --version
----
...
====
----
phpCompatInfo version 4.3.0 DB built Jun 16 2015 10:05:54 CEST
----
====
