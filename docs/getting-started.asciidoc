...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.9.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.9.phar
$ mv phpcompatinfo-5.0.9.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.9.phar
$ php phpcompatinfo-5.0.9.phar --version
----
...
====
----
phpCompatInfo version 5.0.9 DB version 1.26.0 built Nov 23 2017 23:28:23 CET
----
====
