...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.0.0.phar
...
$ php phpcompatinfo-4.0.0.phar --version
----
...
====
----
phpCompatInfo version 4.0.0 DB built Apr 04 2015 08:34:02 CEST
----
====
