...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-3.7.2.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-3.7.2.phar
$ mv phpcompatinfo-3.7.2.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-3.7.2.phar
$ php phpcompatinfo-3.7.2.phar --version
----
