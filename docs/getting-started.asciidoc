...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.0.0-beta3.phar
...
$ php phpcompatinfo-4.0.0-beta3.phar --version
----
...
====
----
phpCompatInfo version 4.0.0-beta3 DB built Feb 27 2015 08:28:03 CET
----
====
