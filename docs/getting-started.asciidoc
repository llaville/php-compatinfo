...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.1.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.1.phar
$ mv phpcompatinfo-5.0.1.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.1.phar
$ php phpcompatinfo-5.0.1.phar --version
----
...
====
----
phpCompatInfo version 5.0.1 DB built Jul 04 2016 20:04:31 CEST
----
====
