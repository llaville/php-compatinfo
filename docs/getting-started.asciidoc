...
<<<<<<< HEAD
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-4.5.2.phar
=======
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-5.0.0.phar
>>>>>>> 5.0
...
[source,bash]
----
$ chmod +x phpcompatinfo-5.0.0.phar
$ mv phpcompatinfo-5.0.0.phar /usr/local/bin/phpcompatinfo
...
$ php phpcompatinfo-5.0.0.phar --version
----
