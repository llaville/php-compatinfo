...
:pharstable:  http://bartlett.laurent-laville.org/get/phpcompatinfo-3.7.3.phar
...
[source,bash]
----
$ chmod +x phpcompatinfo-3.7.3.phar
$ mv phpcompatinfo-3.7.3.phar /usr/local/bin/phpcompatinfo
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-3.7.3.phar
$ php phpcompatinfo-3.7.3.phar --version
----
