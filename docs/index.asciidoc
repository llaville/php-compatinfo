...
.v4 deprecated
--
*Last Branch 4 Release* [label label-danger]#{deprecated}#

It was published on {deprecatedPubDate}.

ifdef::basebackend-bootstrap[]
link:./manual/4.4/en/getting-started.html["Learn more",role="primary",icon="glyphicon-book",options="block"]
endif::[]

ifndef::basebackend-bootstrap[]
link:./manual/4.4/en/getting-started.html[Learn more]
endif::[]
--
====
...
[label label-primary]#CompatInfo# takes advantage of new features in PHP 5.4.0 or greater.
--
unfloat::[]
