...
Last branch 3 release was published on April 15, 2015.

ifdef::basebackend-bootstrap[]
link:./manual/3.7/en/getting-started.html["Learn more",role="primary",options="block"]
endif::[]

ifndef::basebackend-bootstrap[]
link:./manual/3.7/en/getting-started.html[Learn more]
endif::[]
--
====
