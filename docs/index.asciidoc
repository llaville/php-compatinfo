...
.v3
--
[bg-success]*Stable Release*

Next release will enhance stability on July 14, 2014.

ifdef::basebackend-bootstrap[]
link:./manual/3.2/en/getting-started.html["Learn more",role="primary",options="block"]
endif::[]

ifndef::basebackend-bootstrap[]
link:./manual/3.2/en/getting-started.html[Learn more]
endif::[]
--
====
