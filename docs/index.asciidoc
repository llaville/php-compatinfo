...
:stable:        3.7.3
:stablePubDate: January 26, 2015
:dev:           4.0.0-beta3
:devPubDate:    February 27, 2015
:toc!:
:toc2!:
:navbar!:
:jumboinfo:
...
ifdef::basebackend-bootstrap[]
link:./manual/4.0/en/getting-started.html["Learn more",role="primary",icon="glyphicon-book",options="block"]
endif::[]
