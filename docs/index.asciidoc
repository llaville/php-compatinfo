...
.v4
--
[bg-danger]*Beta Release*

First beta release was published on February 4, 2015.

ifdef::basebackend-bootstrap[]
link:./manual/4.0/en/getting-started.html["Learn more",role="primary",options="block"]
endif::[]

ifndef::basebackend-bootstrap[]
link:./manual/4.0/en/getting-started.html[Learn more]
endif::[]
--
====
