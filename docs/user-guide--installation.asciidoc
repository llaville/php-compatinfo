...
{
    "require": {
        "bartlett/php-compatinfo": "4.0.0-RC1"
    }
}
----
...
[source,bash]
----
$ php composer.phar create-project bartlett/php-compatinfo /path/to/install 4.0.0-RC1
----
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-4.0.0-RC1.phar
$ chmod +x phpcompatinfo-4.0.0-RC1.phar
$ mv phpcompatinfo-4.0.0-RC1.phar /usr/local/bin/phpcompatinfo
$ phpcompatinfo
----
...
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-4.0.0-RC1.phar
$ php phpcompatinfo-4.0.0-RC1.phar
----
