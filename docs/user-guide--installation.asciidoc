...
[source,bash]
----
$ php composer.phar create-project bartlett/php-compatinfo /path/to/install 4.5.2
----
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-4.5.2.phar
$ chmod +x phpcompatinfo-4.5.2.phar
$ mv phpcompatinfo-4.5.2.phar /usr/local/bin/phpcompatinfo
$ phpcompatinfo
----
