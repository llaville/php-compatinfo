...
[source,bash]
----
$ php composer.phar create-project bartlett/php-compatinfo /path/to/install 4.4.1
----
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/phpcompatinfo-4.4.1.phar
$ chmod +x phpcompatinfo-4.4.1.phar
$ mv phpcompatinfo-4.4.1.phar /usr/local/bin/phpcompatinfo
$ phpcompatinfo
----
