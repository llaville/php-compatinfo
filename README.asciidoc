...
* download the phar version http://bartlett.laurent-laville.org/get/phpcompatinfo-4.2.0.phar[4.2.0]
* install via https://packagist.org/packages/bartlett/php-compatinfo/[packagist] the current source dev-master or the stable version 4.2.0

== Documentation

The documentation for PHP CompatInfo 4.2
in http://php5.laurent-laville.org/compatinfo/manual/4.2/en/[English]
