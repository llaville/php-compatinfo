...
* download the phar version http://bartlett.laurent-laville.org/get/phpcompatinfo-3.4.0.phar[3.4.0]
* install via https://packagist.org/packages/bartlett/php-compatinfo/[packagist] the current source 3.x-dev or the stable version 3.4.0

== Documentation

The documentation for PHP CompatInfo 3.4 is available
in http://php5.laurent-laville.org/compatinfo/manual/3.4/en/[English]
