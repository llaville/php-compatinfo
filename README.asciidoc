...
Have a look on https://github.com/llaville/php-compat-info/releases/tag/3.7.3[tag 3.7.3] for previous stable API 3.0

== Install

You can either :

* download the phar version http://bartlett.laurent-laville.org/get/phpcompatinfo-4.0.0.phar[4.0.0]
* install via https://packagist.org/packages/bartlett/php-compatinfo/[packagist] the current source dev-master or the stable version 4.0.0

== Documentation

The documentation for PHP CompatInfo 4.0 is available
in http://php5.laurent-laville.org/compatinfo/manual/4.0/en/[English]
