...
* download the phar version http://bartlett.laurent-laville.org/get/phpcompatinfo-3.5.0.phar[3.5.0]
* install via https://packagist.org/packages/bartlett/php-compatinfo/[packagist] the current source dev-master or the stable version 3.5.0

== Documentation

The documentation for PHP CompatInfo 3.5 is available
in http://php5.laurent-laville.org/compatinfo/manual/3.5/en/[English]
